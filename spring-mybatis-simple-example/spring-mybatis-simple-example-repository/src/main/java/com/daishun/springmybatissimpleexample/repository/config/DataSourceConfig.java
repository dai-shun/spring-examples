package com.daishun.springmybatissimpleexample.repository.config;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.daishun.springmybatissimpleexample.repository.dao"}, sqlSessionFactoryRef = "exampleSqlSessionFactory")
@tk.mybatis.spring.annotation.MapperScan(basePackages = {"com.daishun.springmybatissimpleexample.repository.mapper"})
